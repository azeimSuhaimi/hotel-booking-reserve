    ...
    <div class="col-lg-8">
        <div class="card">
            <div class="card-body">
                ...
                <form class="form-horizontal" onsubmit="confirmAndSubmit(this)" action="{{route('store.team')}}" method="post" enctype="multipart/form-data">
                    @csrf
                    <div class="row mb-3">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-8 col-xl-9">
                            <input type="position" class="form-control @error('position') is-invalid @enderror" name="position" value="{{ old('position') }}" id="position" placeholder="Position">
                            @error('position')
                                <span class=" invalid-feedback mt-2">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-8 col-xl-9">
                            <input type="facebook" class="form-control @error('facebook') is-invalid @enderror" name="facebook" value="{{ old('facebook') }}" id="facebook" placeholder="facebook">
                            @error('facebook')
                                <span class=" invalid-feedback mt-2">{{ $message }}</span>
                            @enderror
                        </div>
                    ...
                    <div class="row mb-3 justify-content-end">
                        <div class="col-8 col-xl-9">
                            <img src="{{asset('team/empty.png')}}" alt="image"
