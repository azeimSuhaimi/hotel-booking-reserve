                ...
                <div class="card">
                    ...
                    <div class="card-body p-4">
                        ...
                        <div class="text-center">
                            <h3 class="mt-4">Email Verification Required </h3>
                            <p class="text-muted mb-0">Thank you for registering! To complete your registration and gain full access to our website, 
                                you need to verify your email address.</p>
                            <p class="text-muted mb-0">An email with a verification link has been sent to your email address. Please check your inbox 
                                (and your spam folder, just in case) and click on the verification link to activate your account.</p>
                            <p class="text-muted mb-0">If you haven't received the email, you can request a new verification email by logging in and 
                                clicking on the "Resend Verification Email" link.</p>
                            <p class="text-muted mb-0">If you continue to experience issues, please contact our support team for assistance. <a class="btn" href="mailto:support@example.com"><b>support@example.com</b></a></p>
                            ...
                            <div class="btn-group">
                                ...
                                <form action="{{route('verification.send')}}" method="post">
                                  @csrf
                                  <button class="btn btn-primary" type="submit">resend varification</button>
                                </form>
                              </div>
                        </div>
